		...
		do {
			try {
				...
				case 1:
					...
					break;
				case 2:
					businessLvelOperation.display_Files("LockedMe_main");
					break;
				case 3:
		...
		do {
			try {
				...
				case 1:
					...
					businessLvelOperation.create_User_Defined_File(fileToAdd, sc);
				...
				case 2:
					...
					businessLvelOperation.create_MainFolder_IfNot_Present("LockedMe_main");
					List<String> filesToDelete =businessLvelOperation.display_File_Locations(fileToDelete, "LockedMe_main");
					...
					if (idx != 0) {
						businessLvelOperation.delete_User_Defined_Files(filesToDelete.get(idx - 1));
					} else {
						
						// If idx == 0, delete all files displayed for the name
						for (String path : filesToDelete) {
							businessLvelOperation.delete_User_Defined_Files(path);
						}
					}
				...
				case 3:
					...
					businessLvelOperation.create_MainFolder_IfNot_Present("LockedMe_main");
					businessLvelOperation.display_File_Locations(fileName, "LockedMe_main");
